      ...
      <div className={styles.home}>
        ...
        <div className={styles.masthead}>
          <div className="container">
            ...
            <p className={styles.humility}>
              Created and maintained by <a href="https://twitter.com/erikras" target="_blank" rel="noopener noreferrer">
              @erikras</a>.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <ul>
            ...
            <li><a href="https://github.com/rackt/react-router" target="_blank" rel="noopener noreferrer">React Router</a></li>
            <li><a href="http://expressjs.com" target="_blank" rel="noopener noreferrer">Express</a></li>
            <li><a href="http://babeljs.io" target="_blank" rel="noopener noreferrer">Babel</a> for ES6 and ES7 magic</li>
            <li><a href="http://webpack.github.io" target="_blank" rel="noopener noreferrer">Webpack</a> for bundling</li>
            <li>
              <a href="http://webpack.github.io/docs/webpack-dev-middleware.html" target="_blank" rel="noopener noreferrer">
                Webpack Dev Middleware
              </a>
            </li>
            <li><a href="https://github.com/glenjamin/webpack-hot-middleware" target="_blank" rel="noopener noreferrer">
              Webpack Hot Middleware</a>
            </li>
            <li><a href="https://github.com/rackt/redux" target="_blank" rel="noopener noreferrer">Redux</a>'s futuristic <a
              href="https://facebook.github.io/react/blog/2014/05/06/flux.html" target="_blank" rel="noopener noreferrer">
              Flux</a> implementation
            </li>
            <li><a href="https://github.com/gaearon/redux-devtools" target="_blank" rel="noopener noreferrer">
              Redux Dev Tools</a> for next
              generation DX (developer experience).
              Watch <a href="https://www.youtube.com/watch?v=xsSnOQynTHs" target="_blank" rel="noopener noreferrer">
                Dan Abramov's talk</a>.
            </li>
            <li><a href="https://github.com/rackt/redux-router" target="_blank" rel="noopener noreferrer">
              Redux Router</a> Keep
              your router state in your Redux store
            </li>
            <li><a href="http://eslint.org" target="_blank" rel="noopener noreferrer">
              ESLint</a> to maintain a consistent code style</li>
            <li><a href="https://github.com/erikras/redux-form" target="_blank" rel="noopener noreferrer">
              redux-form</a> to manage form state
              in Redux
            </li>
            <li><a href="https://github.com/sslotsky/violet-paginator" target="_blank" rel="noopener noreferrer">
              violet-paginator</a> to manage list state
              in Redux, including pagination, sorting, filtering, updating, and more.
            </li>
            <li><a href="https://github.com/erikras/multireducer" target="_blank" rel="noopener noreferrer">
              multireducer</a> combine several
              identical reducer states into one key-based reducer
            </li>
            <li><a href="https://github.com/webpack/style-loader" target="_blank" rel="noopener noreferrer">
              style-loader</a> and <a
              href="https://github.com/jtangelder/sass-loader" target="_blank" rel="noopener noreferrer">
              sass-loader</a> to allow import of
              stylesheets
            </li>
            <li><a href="https://github.com/shakacode/bootstrap-sass-loader" target="_blank" rel="noopener noreferrer">
              bootstrap-sass-loader</a>
              and <a
                href="https://github.com/gowravshekar/font-awesome-webpack" target="_blank" rel="noopener noreferrer">
                font-awesome-webpack</a> to
          ...
          <dl>
            ...
            <dd>
              ...
              still-experimental <a href="https://github.com/erikras/redux-form" target="_blank" rel="noopener noreferrer">
              redux-form</a> to
            ...
            <dd>
              ...
              <a href="https://www.npmjs.com/package/violet-paginator" target="_blank" rel="noopener noreferrer">
                violet-paginator</a> to
